...
def _init_main__menu():
    ...
    launchPage = Button(window, text='Start Simulation', width = 18, command = lambda v=0: _clientHandler_(0, errorText, [holderLabel_x, holderLabel_y, calcSpeedText, percentageOfLivabilityText]))
    launchPage.place(x = 55, y = 440)
